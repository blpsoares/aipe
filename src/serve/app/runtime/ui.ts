...
// (j-20260830-sk) The Agora board section's visibility state (agoraBoardOpen)
// was removed with the section itself: the board is now its own always-visible
// page (views/quadro.view.tsx), so there is no collapse choice to remember.
